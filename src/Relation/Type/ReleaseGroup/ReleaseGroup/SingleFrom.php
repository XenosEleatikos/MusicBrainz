...
/**
 * This indicates that a single or EP release group includes at least one track taken from an album release group. This allows a release group to be linked to its associated singles and EPs.
 *
