...
/**
 * This links a remix release group to the source release group and is used to indicate that the release group includes remixed versions of all (or most of) the tracks in the other release group.
 *
